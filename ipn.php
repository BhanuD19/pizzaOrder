...
if (!$fp) {
    ...
    fclose($fh);
    //email
    $mail_From = "From: mamma_marias@yahoo.com";
    $mail_To = $email;
...
$trasactiondate=date("m/d/Y");
            ...
            /*if (($payment_status == 'Completed') && ($receiver_email == "mamma__1330248786_biz@yahoo.com") && 
            ...
            if (($payment_status == 'Pending') && ($receiver_email == "mamma__1330248786_biz@yahoo.com") && 
            ($payment_amount == $amount_they_should_have_paid) && 
            ($payment_currency == "PHP") ) { //txn_id isn't same as previous to stop duplicate payments. You will need to write a function to do this check.
                ...
                mysql_query("INSERT INTO marias_orders(cusid, amountpaid, status, transactiondate, transactioncode, mode)VALUES('$item_name', '$payment_amount', '$payment_status1', '$trasactiondate', '$item_number', '$mode')");
            ...
            fclose($fh);
                ...
                $mail_To = "mamma_marias@yahoo.com";
